...
function startFifth() {
  ...
  if (
    prompt(quiz[0].question + " " + quiz[0].options.join(" ")) == quiz[0].correctAnswer
  ) {
    correctCount++;
  }

  if (
    prompt(quiz[1].question + " " + quiz[1].options.join(" ")) == quiz[1].correctAnswer
  ) {
    correctCount++;
  }

  if (
    prompt(quiz[2].question + " " + quiz[2].options.join(" ")) == quiz[2].correctAnswer
  ) {
    correctCount++;
  }
